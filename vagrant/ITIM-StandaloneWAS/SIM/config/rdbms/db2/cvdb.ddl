...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.LObject TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.Name TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.CryptoParams TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.Link TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.AppID TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.CustomAttr TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.ObjectGroup TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.SubjectAN TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.DIGEST TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.CV_KEYSTORE TO USER db2inst1;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CVDB.CV_METADATA TO USER db2inst1;
