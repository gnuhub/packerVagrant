...
bash "Configure TDS v6.1" do
	cwd "/opt/IBM/ldap/V6.1/sbin"
	user "root"
	group "root"
	code <<-EOH
...
bash "Configure TDS WAS App" do
	cwd "/opt/ibm/ldap/V6.1/idstools/"
	user "root"
	group "root"
	code <<-EOH
		#echo "Configure TDS WAS App"
		/installFiles/tdsV6.1/appsrv/install.sh -installRoot /opt/TDS_WAS/
