...
GRANT SELECT,INSERT,DELETE,UPDATE ON ITIML000.SIBOWNER TO USER db2inst1;

GRANT SELECT,INSERT,DELETE,UPDATE ON ITIML000.SIBOWNERO TO USER db2inst1;

GRANT SELECT,INSERT ON ITIML000.SIBCLASSMAP TO USER db2inst1;

GRANT SELECT,INSERT ON ITIML000.SIBLISTING TO USER db2inst1;

GRANT SELECT,INSERT,DELETE,UPDATE ON ITIML000.SIB000 TO USER db2inst1;

GRANT SELECT,INSERT,DELETE,UPDATE ON ITIML000.SIB001 TO USER db2inst1;

GRANT SELECT,INSERT,DELETE,UPDATE ON ITIML000.SIB002 TO USER db2inst1;

GRANT SELECT,INSERT,UPDATE,DELETE ON ITIML000.SIBXACTS TO USER db2inst1;

GRANT SELECT,INSERT,UPDATE ON ITIML000.SIBKEYS TO USER db2inst1;
